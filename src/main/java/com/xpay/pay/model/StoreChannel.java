...
public class StoreChannel {
	...
	public enum PaymentGateway {
		...
		, BAIFU(5, "trade.weixin.gzpay", "query", "unified.trade.refund"), JUZHEN(6, "070201", "070101", ""), CHINAUMSV2(7, "bills.getQRCode", "bills.query", "bills.refund"), KEFU(8, "msBank_WeChatPay", "msBank_ScanPayQuery", "");
