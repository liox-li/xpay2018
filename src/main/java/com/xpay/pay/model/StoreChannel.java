...
public class StoreChannel {
	...
	public enum PaymentGateway {
		MIAOFU("unifiedorder", "query", "refund"), SWIFTPASS("unified.trade.pay", "unified.trade.query", "unified.trade.refund"), CHINAUMS("yuedan.getQRCode", "yuedan.query", "yuedan.refund"), RUBIPAY("unified.trade.pay", "unified.trade.query", "unified.trade.refund")
