...
@Component
public class ChinaPnrProxy implements IPaymentProxy {
	...
	public void init(String props){
		...
		try{
			Map<String,String> config = (Map<String,String>)instance.readValue(props,HashMap.class);
...
//		chinaUmsRequest.setSystemId(appId);
	...
	public static void main(String args[]){
		 ...
		 * this.merCustId = config.get("merCustId");
			...
			this.divAcctId = config.get("divAcctId");
		 */
		ChinaPnrProxy proxy = new ChinaPnrProxy();
